          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-3">
            <Link 
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = '0 0 25px rgba(57, 225, 227, 0.7), 0 0 40px rgba(244, 70, 160, 0.5)';
              }}
              onMouseLeave={(e) => {
            ...
            <Link 
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.transform = 'scale(1.05)';
                e.currentTarget.style.boxShadow = '0 0 25px rgba(244, 70, 160, 0.7), 0 0 40px rgba(57, 225, 227, 0.5)';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = 'scale(1)';
