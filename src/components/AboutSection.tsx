        ...
        <div className="mb-32">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              ...
              <div className="relative w-64 h-64 md:w-80 md:h-80">
                ...
                >
                  <div className="w-full h-full bg-gradient-to-br from-purple-900/20 to-pink-900/20 flex items-center justify-center">
                    <span className="text-6xl font-rajdhani font-semibold" style={{ color: '#f7c948' }}>
                      AF
                    </span>
                  </div>
                </div>
            ...
            <div className="space-y-6">
              <h1 className="text-3xl md:text-4xl font-rajdhani font-semibold" style={{ color: '#f7c948' }}>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {timelineData.map((item, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-rajdhani font-semibold mb-1" style={{ color: '#f7c948' }}>
                  {item.title}
                </h3>
